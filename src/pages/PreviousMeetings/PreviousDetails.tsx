...
import Notes from "../../components/AdminTabs/Notes";
...
export default function PreviousDetails() {
  ...
  const tabs = [
    ...
    { id: "note", label: t.notes, component: <Notes/> },
  ...
  return (
    ...
    >
      ...
      >
        <MeetingDetailsHead path='/admin/previous'/>
      </motion.div>
      ...
      >
        ...
        <MeetingDateTime isUpcoming={false} time={formattedTime} day={formattedDate}/>
      </motion.div>
